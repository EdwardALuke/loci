...
\begin{tikzpicture}[
  ...
  \fill[black] (32.945,1.353) circle[radius=1.353mm];
  \fill[black] (64.358,55.762) circle[radius=1.353mm];
  \fill[black] (1.353,56.073) circle[radius=1.353mm];

  \fill[black] (127.364,1.353) circle[radius=1.353mm];
  \fill[black] (158.778,55.762) circle[radius=1.353mm];
  \fill[black] (95.772,56.073) circle[radius=1.353mm];
