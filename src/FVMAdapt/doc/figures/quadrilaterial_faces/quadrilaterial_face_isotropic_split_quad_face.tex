...
\begin{tikzpicture}[
  ...
  % Draw the original boundary in black, then the split-node connections in red.
  ...
  \fill[black] (topLeft) circle[radius=1.353mm];
  \fill[black] (topRight) circle[radius=1.353mm];
  \fill[black] (bottomRight) circle[radius=1.353mm];
  \fill[black] (bottomLeft) circle[radius=1.353mm];
