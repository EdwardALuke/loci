...
\begin{tikzpicture}[
  ...
  \draw[axis] (Oaxis) -- (-0.28,-0.65,-0.55) node[below right,font=\scriptsize] {$\xi$};
  \draw[axis] (Oaxis) -- (-1.38,0.43,-0.55) node[above left,font=\scriptsize] {$\eta$};
  \draw[axis] (Oaxis) -- (-1.38,-0.65,0.55) node[above,font=\scriptsize] {$\zeta$};
