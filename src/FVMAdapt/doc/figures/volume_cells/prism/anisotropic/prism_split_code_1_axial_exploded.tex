...
\begin{tikzpicture}[
  ...
  \draw[axis] (Oaxis) -- (-0.32,-0.55,-0.68) node[below right,font=\scriptsize] {$\xi$};
  \draw[axis] (Oaxis) -- (-1.28,0.39,-0.68) node[above left,font=\scriptsize] {$\eta$};
  \draw[axis] (Oaxis) -- (-1.28,-0.55,0.28) node[above,font=\scriptsize] {$\zeta$};
