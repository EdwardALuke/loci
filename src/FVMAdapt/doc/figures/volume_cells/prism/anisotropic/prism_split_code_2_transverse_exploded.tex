...
\begin{tikzpicture}[
  ...
  \newcommand{\drawquadcolumn}{%
    % Bottom and top end-face fragments: original boundary pieces stay black,
    ...
    \foreach \p in {B0,T0} {
      \fill[black] (\p) circle[radius=0.58mm];
    }
  ...
  \draw[axis] (Oaxis) -- (-0.32,-0.55,-0.70) node[below right,font=\scriptsize] {$\xi$};
  \draw[axis] (Oaxis) -- (-1.28,0.39,-0.70) node[above left,font=\scriptsize] {$\eta$};
  \draw[axis] (Oaxis) -- (-1.28,-0.55,0.26) node[above,font=\scriptsize] {$\zeta$};
