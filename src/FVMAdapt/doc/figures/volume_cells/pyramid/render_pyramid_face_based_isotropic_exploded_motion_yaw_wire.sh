...
tex_file="$script_dir/pyramid_face_based_isotropic_exploded.tex"
base_name=pyramid_face_based_isotropic_exploded_motion_yaw_wire
out_gif="$script_dir/${base_name}.gif"

work_dir=$(mktemp -d "${TMPDIR:-/tmp}/fvmadapt-pyramid-face-motion-yaw-wire.XXXXXX")
