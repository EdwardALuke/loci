...
\begin{tikzpicture}[
  ...
  y=-1mm,
  line join=round,
  edge/.style={draw=black,line width=0.865mm},
  splitline/.style={draw=splitred,line width=0.865mm},
  arrow/.style={draw=black,line width=1.05mm,-{Latex[round,length=4.8mm,width=3.6mm]}}
]
  ...
  \fill[black] (left0) circle[radius=1.353mm];
  \fill[black] (left1) circle[radius=1.353mm];
  \fill[black] (left2) circle[radius=1.353mm];
  \fill[black] (left3) circle[radius=1.353mm];

  \fill[black] (right0) circle[radius=1.353mm];
  \fill[black] (right1) circle[radius=1.353mm];
  \fill[black] (right2) circle[radius=1.353mm];
  \fill[black] (right3) circle[radius=1.353mm];
