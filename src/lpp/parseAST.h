...
public:
  ...
  {nodeType=AST_type::elementType::ND_SYNTAXERR;}
...
public:
  ...
  AST_Token() {nodeType = AST_type::elementType::OP_ERROR; ; lineno=-1; }
} ;
...
public:
  ...
  {nodeType = AST_type::elementType::ND_SIMPLE_STATEMENT ;}
...
public:
  ...
  void accept(AST_visitor &v) ;
  ASTP clone() const ;
  AST_typeSpec() { nodeType = AST_type::elementType::ND_TYPE_SPEC ; }
} ;
...
public:
  ...
  void accept(AST_visitor &v) ;
  ASTP clone() const ;
  AST_declaration() { nodeType = AST_type::elementType::ND_DECL ; }
} ;
...
public:
  ...
  void accept(AST_visitor &v) ;
  ASTP clone() const ;
  AST_controlStatement() {nodeType = AST_type::elementType::OP_ERROR; }
  void constructIf(ASTP tok, ASTP C, ASTP IFBLOCK, ASTP ELSE, ASTP ELSEBLOCK) {
    nodeType = AST_type::elementType::ND_CTRL_IF ;
    controlType = tok ;
    parts.push_back(C) ;
