...
#endif
    Entity ** get_base_ptr() const { Entity ** p = 0 ; if(alloc_id>=0) p = ((Entity **)GPUstoreAllocateData[alloc_id].alloc_ptr2 - GPUstoreAllocateData[alloc_id].base_offset) ; return p ; }
